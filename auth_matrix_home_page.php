...
<body>
    <div class="container">
        ...
        <div class="icon-buttons">
            <form class="icon-button" action="matrix_attendance.php" method="post">
            ...
            <form class="icon-button" action="staff_display.php" method="post">
                <!-- Add your input fields or other form elements here -->
                <input type="hidden" name="user_id" value="<?php echo htmlspecialchars($_SESSION['user_id']); ?>">
                <button type="submit" style="border: none; background: none;">
                    <img src="management.png" width="30" height="30" alt="Icon 2" class="img-fluid">
                </button>
                <span>Staff</span>
            </form>
            <form class="icon-button" action="placement_pri_dir.php" method="post">
                <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id']; ?>">
                <button type="submit" style="border: none; background: none;">
            ...
            <form class="icon-button" action="faculty_count.php" method="post">
                <!-- Add your input fields or other form elements here -->
                <input type="hidden" name="user_id" value="<?php echo htmlspecialchars($_SESSION['user_id']); ?>">
                <button type="submit" style="border: none; background: none;">
                    <img src="group.png" width="30" height="30" alt="Icon 2" class="img-fluid">
                </button>
                <span>faculty</span>
            </form>
            <form class="icon-button" action="matrix_fee.php" method="post">
                <input type="hidden" name="user_id" value="<?php echo htmlspecialchars($_SESSION['user_id']); ?>">
                <button type="submit" style="border: none; background: none;">
            ...
            <!-- Form Group 2 -->
            <form class="icon-button" action="matrix_results.php" method="post">
                <!-- Add your input fields or other form elements here -->
                <input type="hidden" name="user_id" value="<?php echo htmlspecialchars($_SESSION['user_id']); ?>">
                <button type="submit" style="border: none; background: none;">
            ...
            <form class="icon-button" action="permission_pri_dir_fac.php" method="post">
                <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id']; ?>">
                <button type="submit" style="border: none; background: none;">
            ...
            <!--form class="icon-button" action="club_home.php" method="post">
                <input type="hidden" name="class_id" value="<!?php echo htmlspecialchars($_SESSION['user_id']); ?>">
                <button type="submit" style="border: none; background: none;">
