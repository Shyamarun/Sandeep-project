...
<body>
    <div class="container">
        <div class="table-container">
                    ...
                    <tbody>
                        <?php foreach ($records as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    <button onclick="updateStatus('Accepted', '<?= $row['reg_num'] ?>','<?= $row['id'] ?>' ,'Requested Accepted by ','<?= $suffix ?>')" class="btn btn-success">Accept</button>
                                    <button onclick="updateStatus('Rejected', '<?= $row['reg_num'] ?>','<?= $row['id'] ?>','Requested Rejected by ','<?= $suffix ?>')" class="btn btn-danger">Reject</button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
            ...
            <script>
                function updateStatus(newStatus, regNum, id, newStage, suffix) {
                    ...
                    xhr.open("POST", "update_pri_dir_std.php", true);
                    ...
                    xhr.send("reg_num=" + regNum + "&status=" + newStatus + "&stage=" + (newStage + suffix) + "&id=" + id);
                }
            </script>
