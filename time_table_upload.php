            ...
            <div class="col-md-6 offset-md-3">
                ...
                if (isset($_POST['upload'])) {
                    ...
                    if (isset($_FILES['file'])) {
                        $uploadDir = 'uploads/time_table' . '/' . $class_id;
                        ...
                        if (move_uploaded_file($_FILES['file']['tmp_name'], $uploadFile)) {
                            ...
                            $query = "INSERT INTO time_table (file_name, file_path,class_id) VALUES ('$fileName', '$filePath','$class_id')";
                ...
                // File Display Logic
                $query = "SELECT * FROM time_table WHERE class_id='$class_id'";
                $result = mysqli_query($conn, $query);
