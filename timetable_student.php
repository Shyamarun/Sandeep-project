...
echo "<center><h2>Timetable</h2></center>";
echo "<table class='table table-bordered'>";
echo "<thead><tr><th><center>Day</center></th>";
for ($i = 1; $i <= 7; $i++) {
    echo "<th><center>Period $i</center></th>";
}
echo "</tr></thead>";

while ($day = $daysResult->fetch_assoc()) {
    echo "<tr><center><td><strong>" . $day['day'] . "</strong></td>";
    for ($i = 1; $i <= 7; $i++) {
...
echo "<center><h2>Faculty Information</h2></center>";
echo "<table class='table table-bordered'><thead><tr><th><center>Subject</center></th><th><center>Faculty Name</center></th><th><center>Contact Number</center></th><th><center>Email</center></th></tr></thead>";
while ($faculty = $facultyResult->fetch_assoc()) {
    echo "<tr><td><center>" . $faculty['subject'] . "</center></td><td><center>" . $faculty['facultyName'] . "</center></td><td><center>" . $faculty['whatsappNumber'] . "</center></td><td><center>" . $faculty['contactEmail'] . "</center></td></tr>";
}
echo "</table>";
echo "</div>";
